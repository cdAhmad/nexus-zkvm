...
use stwo::{
    ...
    prover::{ poly::{ circle::CircleEvaluation, BitReversedOrder } },
    core::{ fields::{ m31::BaseField, qm31::SecureField }, ColumnVec },
};
...
>(
    ...
    let mut logup_gen = LogupTraceGenerator::new(
        BitwiseTable::new(ELEM_BITS, EXPAND_BITS, 0).column_bits()
    );
    ...
    for [
        ...
        for vec_row in 0..1 <<
            (BitwiseTable::new(ELEM_BITS, EXPAND_BITS, 0).column_bits() - LOG_N_LANES) {
